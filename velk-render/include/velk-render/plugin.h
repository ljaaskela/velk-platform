...
/** @brief IBuffer whose storage is a region of a GpuArena; created via IGpuArena::create_buffer. */
inline constexpr Uid ArenaBuffer{"2403d3dd-d9bc-4ba1-a5a4-60e8fa5c6566"};
